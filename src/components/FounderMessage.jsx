            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6">
                <div className="bg-stone-50 border border-stone-200/80 rounded-3xl p-8 sm:p-12 shadow-sm relative overflow-hidden flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="flex-shrink-0 text-center">
                        ...
                        <span className="text-[9px] uppercase font-bold text-orange-600 block mt-0.5">Varanasi Yatra</span>
                    </div>
                    ...
                    <div className="flex-1 text-left space-y-4">
                        ...
                        <div className="pt-2 border-t border-stone-200 flex items-center justify-between">
                            <div>
                                <h5 className="text-xs font-bold text-stone-900">The Varanasi Yatra Team</h5>
