...
const { runBaselineTest } = require('./baseline.cjs');
const { runStressTest } = require('./stress.cjs');
const { runSpikeTest } = require('./spike.cjs');
const { runSoakTest } = require('./soak.cjs');
